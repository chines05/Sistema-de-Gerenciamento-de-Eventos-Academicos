...
public class Atividade {
    ...
    public Atividade(String nome, String descricao, String dataInicio, String dataFim, int vagasTotal, int vagasDisponivel) {
        this.nome = nome;
    ...
    public Atividade(String nome, String descricao, String dataInicio, String dataFim, int id) {
        this.id = id;
        this.nome = nome;
        this.descricao = descricao;
        this.dataInicio = dataInicio;
